...
void __init ipq806x_configure_gpios(struct pm8xxx_gpio_init *data, int len)
{
	int i, rc;
...
static struct pm8xxx_misc_platform_data ipq806x_pm8921_misc_pdata = {
	.priority		= 0,
};
...
static struct pm8xxx_led_platform_data ipq806x_pm8921_leds_pdata = {
		.led_core = &pm8921_led_core_pdata,
		.configs = pm8921_led_configs,
		.num_configs = ARRAY_SIZE(pm8921_led_configs),
};

static struct pm8xxx_adc_amux ipq806x_pm8921_adc_channels_data[] = {
...
static struct pm8xxx_adc_properties ipq806x_pm8921_adc_data = {
	.adc_vdd_reference	= 1800, /* milli-voltage for this adc */
	.bitresolution		= 15,
	.bipolar                = 0,
};

static struct pm8xxx_adc_platform_data ipq806x_pm8921_adc_pdata = {
	.adc_channel		= ipq806x_pm8921_adc_channels_data,
	.adc_num_board_channel	= ARRAY_SIZE(ipq806x_pm8921_adc_channels_data),
	.adc_prop		= &ipq806x_pm8921_adc_data,
	.adc_mpp_base		= PM8921_MPP_PM_TO_SYS(1),
};

static struct pm8xxx_mpp_platform_data
ipq806x_pm8921_mpp_pdata __devinitdata = {
	.mpp_base	= PM8921_MPP_PM_TO_SYS(1),
};

static struct pm8xxx_gpio_platform_data
ipq806x_pm8921_gpio_pdata __devinitdata = {
	.gpio_base	= PM8921_GPIO_PM_TO_SYS(1),
};

static struct pm8xxx_irq_platform_data
ipq806x_pm8921_irq_pdata __devinitdata = {
...
ipq806x_pm8921_rtc_pdata = {
	.rtc_write_enable       = false,
	.rtc_alarm_powerup      = false,
};

static int ipq806x_pm8921_therm_mitigation[] = {
	1100,
	700,
	600,
	325,
...
ipq806x_pm8921_chg_pdata __devinitdata = {
	.update_time		= 60000,
	...
	.thermal_mitigation	= ipq806x_pm8921_therm_mitigation,
	.thermal_levels		= ARRAY_SIZE(ipq806x_pm8921_therm_mitigation),
};

static struct pm8xxx_ccadc_platform_data
ipq806x_pm8xxx_ccadc_pdata = {
	.r_sense_uohm		= 10000,
	.calib_delay_ms		= 600000,
};

static struct pm8921_bms_platform_data
ipq806x_pm8921_bms_pdata __devinitdata = {
...
ipq806x_pm8921_platform_data __devinitdata = {
	.irq_pdata		= &ipq806x_pm8921_irq_pdata,
	.gpio_pdata		= &ipq806x_pm8921_gpio_pdata,
	.mpp_pdata		= &ipq806x_pm8921_mpp_pdata,
	.rtc_pdata		= &ipq806x_pm8921_rtc_pdata,
	.pwrkey_pdata		= &ipq806x_pm8921_pwrkey_pdata,
	.misc_pdata		= &ipq806x_pm8921_misc_pdata,
	.leds_pdata		= &ipq806x_pm8921_leds_pdata,
	.adc_pdata		= &ipq806x_pm8921_adc_pdata,
	.charger_pdata		= &ipq806x_pm8921_chg_pdata,
	.bms_pdata		= &ipq806x_pm8921_bms_pdata,
	.ccadc_pdata		= &ipq806x_pm8xxx_ccadc_pdata,
};

static struct msm_ssbi_platform_data ipq806x_ssbi_pm8921_pdata __devinitdata = {
