...
#ifndef __ASM_ARCH_MSM_IRQS_IPQ806X_H
#define __ASM_ARCH_MSM_IRQS_IPQ806X_H
...
#define USB2_HSIC_IRQ				(GIC_SPI_START + 33)
#define SLIMBUS0_BAM_EE1_IRQ			(GIC_SPI_START + 34)
#define	PCIE20_INT_MSI				(GIC_SPI_START + 35)
#define	PCIE20_INTA				(GIC_SPI_START + 36)
#define	PCIE20_INTB				(GIC_SPI_START + 37)
#define	PCIE20_INTC				(GIC_SPI_START + 38)
#define	PCIE20_INTD				(GIC_SPI_START + 39)
#define	PCIE20_INT_PLS_HP			(GIC_SPI_START + 40)
#define	PCIE20_INT_PLS_ERR			(GIC_SPI_START + 41)
#define	PCIE20_INT_PLS_PME			(GIC_SPI_START + 42)
#define	PCIE20_INT_BRIDGE_FLUSH_N		(GIC_SPI_START + 43)
#define	PCIE20_INT_LINK_UP			(GIC_SPI_START + 44)
#define	PCIE20_INT_LINK_DOWN			(GIC_SPI_START + 45)
#define	PCIE20_INT_PME_LEGACY			(GIC_SPI_START + 46)
#define	PCIE20_INT_AER_LEGACY			(GIC_SPI_START + 47)
#define	PCIE20_INT_HP_LEGACY			(GIC_SPI_START + 48)
...
#define PCIE20_1_INTB				(GIC_SPI_START + 59)
#define PCIE20_1_INTC				(GIC_SPI_START + 60)
#define PCIE20_1_INTD				(GIC_SPI_START + 61)
#define PCIE20_INT_PLS_HP_1_IRQ			(GIC_SPI_START + 62)
#define PCIE20_INT_PLS_ERR_1_IRQ		(GIC_SPI_START + 63)
#define PCIE20_INT_PLS_PME_1_IRQ		(GIC_SPI_START + 64)
#define PCIE20_INT_BRIDGE_FLUSH_N_1_IRQ		(GIC_SPI_START + 65)
#define PCIE20_INT_PLS_LINK_UP_1_IRQ		(GIC_SPI_START + 66)
#define PCIE20_INT_PLS_LINK_DOWN_1_IRQ		(GIC_SPI_START + 67)
#define PCIE20_INT_PME_LEGACY_1_IRQ		(GIC_SPI_START + 68)
#define PCIE20_INT_AER_LEGACY_1_IRQ		(GIC_SPI_START + 69)
#define PCIE20_INT_HP_LEGACY_1_IRQ		(GIC_SPI_START + 70)
#define PCIE20_2_INT_MSI			(GIC_SPI_START + 71)
#define PCIE20_2_INTA				(GIC_SPI_START + 72)
#define PCIE20_2_INTB				(GIC_SPI_START + 73)
#define PCIE20_2_INTC				(GIC_SPI_START + 74)
#define PCIE20_2_INTD				(GIC_SPI_START + 75)
#define PCIE20_INT_PLS_HP_2_IRQ			(GIC_SPI_START + 76)
#define PCIE20_INT_PLS_ERR_2_IRQ		(GIC_SPI_START + 77)
#define PCIE20_INT_PLS_PME_2_IRQ		(GIC_SPI_START + 78)
#define PCIE20_INT_BRIDGE_FLUSH_N_2_IRQ		(GIC_SPI_START + 79)
#define PCIE20_INT_PLS_LINK_UP_2_IRQ		(GIC_SPI_START + 80)
#define PCIE20_INT_PLS_LINK_DOWN_2_IRQ		(GIC_SPI_START + 81)
#define PCIE20_INT_PME_LEGACY_2_IRQ		(GIC_SPI_START + 82)
#define PCIE20_INT_AER_LEGACY_2_IRQ		(GIC_SPI_START + 83)
#define PCIE20_INT_HP_LEGACY_2_IRQ		(GIC_SPI_START + 84)
#define LPASS_AUDIO_IF_OUT0_IRQ			(GIC_SPI_START + 85)
...
#define USB30_OTG_IRQ_1				(GIC_SPI_START + 107)
#define USB30_HS_PHY_IRQ_1			(GIC_SPI_START + 108)
#define USB30_POWER_EVENT_IRQ_1			(GIC_SPI_START + 109)
#define USB30_EE1_IRQ_1				(GIC_SPI_START + 110)
#define USB30_EE2_IRQ_1				(GIC_SPI_START + 111)
...
#define IPQ806X_GSBI4_UARTDM_IRQ		(GIC_SPI_START + 152)
...
#define IPQ806X_GSBI1_UARTDM_IRQ		(GIC_SPI_START + 193)
#define IPQ806X_GSBI1_QUP_IRQ			(GIC_SPI_START + 194)
#define IPQ806X_GSBI2_UARTDM_IRQ		(GIC_SPI_START + 195)
#define IPQ806X_GSBI2_QUP_IRQ			(GIC_SPI_START + 196)
...
#define USB30_EE2_IRQ				(GIC_SPI_START + 204)
#define USB30_EE1_IRQ				(GIC_SPI_START + 205)
#define USB30_POWER_EVENT_IRQ			(GIC_SPI_START + 206)
#define USB30_HS_PHY_IRQ			(GIC_SPI_START + 207)
#define USB30_OTG_IRQ				(GIC_SPI_START + 208)
...
#define	IPQ806X_CSIPHY_2LN_IRQ			(GIC_SPI_START + 228)
...
#define INT_ADSP_A11_SMSM	LPASS_SPDIFTX_IRQ
