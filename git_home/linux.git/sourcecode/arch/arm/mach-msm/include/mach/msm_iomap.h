...
#define MSM_SFAB_BASE		IOMEM(0xFB740000)
#define MSM_AFAB_BASE		IOMEM(0xFB750000)
#define MSM_NSSFAB_0_BASE	IOMEM(0xFB760000)
#define MSM_NSSFAB_1_BASE	IOMEM(0xFB770000)
#define MSM_DAY_CFG_BASE	IOMEM(0xFB780000)
