...
/* Don't do DNS lookup in FTP, else it will spend so much time to start the service. */
#undef gethostbyname
#undef gethostbyaddr
...
inline struct hostent *gethostbyaddr(const void *addr,socklen_t len, int type)
{
        return NULL;
}
