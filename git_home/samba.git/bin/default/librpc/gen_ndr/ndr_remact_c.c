	...
	*state->orig.out.hr = *state->tmp.out.hr;
	{
		...
		if (state->orig.out.ifaces != state->tmp.out.ifaces) {
	...
	}
	{
		...
		if (state->orig.out.results != state->tmp.out.results) {
				 ...
				 WERROR *result)
{
	...
	r.out.ServerVersion = _ServerVersion;
	r.out.hr = _hr;
	r.out.ifaces = _ifaces;
