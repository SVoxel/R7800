...
#include "bin/default/librpc/gen_ndr/ndr_wmi_c.h"
	...
	*state->orig.out.ORPCthat = *state->tmp.out.ORPCthat;
	{
		...
		if (state->orig.out.apObjects != state->tmp.out.apObjects) {
	...
	*state->orig.out.ORPCthat = *state->tmp.out.ORPCthat;
	{
		...
		_copy_len_Nonce = 16;
		if (state->orig.out.Nonce != state->tmp.out.Nonce) {
