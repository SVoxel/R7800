...
static const struct dcesrv_interface dcesrv_xattr_interface = {
	.name		    = "xattr",
...
#ifdef DCESRV_INTERFACE_XATTR_FLAGS
	.flags              = DCESRV_INTERFACE_XATTR_FLAGS
#else
	.flags              = 0
#endif
};
...
#ifdef DCESRV_INTERFACE_XATTR_INIT_SERVER
	    .init_server = DCESRV_INTERFACE_XATTR_INIT_SERVER,
#else
	    .init_server = xattr__op_init_server,
#endif
	    .interface_by_uuid = xattr__op_interface_by_uuid,
	    .interface_by_name = xattr__op_interface_by_name
	};
