...
static PyTypeObject policyagent_SyntaxType = {
	PyObject_HEAD_INIT(NULL) 0,
	.tp_name = "policyagent.policyagent_abstract_syntax",
	.tp_doc = "policyagent_abstract_syntax()\n"PY_DOC_POLICYAGENT_SYNTAX,
	.tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE,
...
void initpolicyagent(void)
{
...
#endif
#ifdef PY_POLICYAGENT_ABSTRACT_SYNTAX_PATCH
	PY_POLICYAGENT_ABSTRACT_SYNTAX_PATCH(&policyagent_SyntaxType);
#endif
	...
	PyModule_AddObject(m, "policyagent_abstract_syntax", (PyObject *)(void *)&policyagent_SyntaxType);
	Py_INCREF((PyObject *)(void *)&policyagent_SyntaxType);
