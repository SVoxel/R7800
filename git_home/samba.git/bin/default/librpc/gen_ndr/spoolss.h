...
struct spoolss_AddMonitorInfo2 {
	const char *monitor_name;/* [charset(URF16),unique] */
	const char *environment;/* [charset(URF16),unique] */
...
struct spoolss_CorePrinterDriver {
	...
	NTTIME driver_date;
	uint64_t driver_version;
	const char *szPackageID;/* [charset(UTF16)] */
}/* [public] */;
...
#else
 { __do_not_use_enum_spoolss_EPrintPropertyType=0x7FFFFFFF}
...
#else
 { __do_not_use_enum_EBranchOfficeJobEventType=0x7FFFFFFF}
