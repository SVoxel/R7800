...
void _decode_credential_data_ndr(struct pipes_struct *p, struct decode_credential_data_ndr *r);
void _decode_upn_dns_info(struct pipes_struct *p, struct decode_upn_dns_info *r);
