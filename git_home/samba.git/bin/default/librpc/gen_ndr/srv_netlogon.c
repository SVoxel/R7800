...
#include "includes.h"
#include "ntdomain.h"
#include "bin/default/librpc/gen_ndr/srv_netlogon.h"
...
/* Tables */
static const struct api_struct api_netlogon_cmds[] = 
{
...
const struct api_struct *netlogon_get_pipe_fns(int *n_fns)
{
	*n_fns = sizeof(api_netlogon_cmds) / sizeof(struct api_struct);
	return api_netlogon_cmds;
}
