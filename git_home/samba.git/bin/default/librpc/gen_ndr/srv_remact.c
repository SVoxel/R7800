...
#include "includes.h"
#include "ntdomain.h"
#include "bin/default/librpc/gen_ndr/srv_remact.h"
...
static bool api_RemoteActivation(struct pipes_struct *p)
{
	...
	r->out.hr = talloc_zero(r, HRESULT);
	if (r->out.hr == NULL) {
		talloc_free(r);
		return false;
	}
	...
	r->out.results = talloc_zero_array(r, HRESULT, r->in.Interfaces);
...
/* Tables */
static const struct api_struct api_IRemoteActivation_cmds[] = 
{
...
const struct api_struct *IRemoteActivation_get_pipe_fns(int *n_fns)
{
	*n_fns = sizeof(api_IRemoteActivation_cmds) / sizeof(struct api_struct);
	return api_IRemoteActivation_cmds;
}
