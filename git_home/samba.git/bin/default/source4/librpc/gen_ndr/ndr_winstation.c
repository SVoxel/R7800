...
static enum ndr_err_code ndr_push_winstation_foo(struct ndr_push *ndr, int flags, const struct winstation_foo *r)
{
...
static enum ndr_err_code ndr_pull_winstation_foo(struct ndr_pull *ndr, int flags, struct winstation_foo *r)
{
