...
static const struct dcesrv_interface dcesrv_winstation_interface = {
	.name		    = "winstation",
...
#ifdef DCESRV_INTERFACE_WINSTATION_FLAGS
	.flags              = DCESRV_INTERFACE_WINSTATION_FLAGS
#else
	.flags              = 0
#endif
};
...
#ifdef DCESRV_INTERFACE_WINSTATION_INIT_SERVER
	    .init_server = DCESRV_INTERFACE_WINSTATION_INIT_SERVER,
#else
	    .init_server = winstation__op_init_server,
#endif
	    .interface_by_uuid = winstation__op_interface_by_uuid,
	    .interface_by_name = winstation__op_interface_by_name
	};
