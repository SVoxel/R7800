...
#define STRING_STATIC_MODULES " pdb_smbpasswd pdb_tdbsam rpc_lsa rpc_reg rpc_lsa_ds rpc_wks rpc_svcctl rpc_ntsvcs rpc_net rpc_netdfs rpc_srv rpc_spoolss rpc_eventlog rpc_samr idmap_tdb auth_sam auth_unix auth_winbind auth_server auth_domain auth_builtin"
